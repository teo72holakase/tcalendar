      ...
      <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Agrega a un usuario al grupo por su nombre de usuario.</p>
          </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <label className="block">
            ...
            <input name="username" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="ej. usuario123" className="mt-1 w-full" />
          </label>
