    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      ...
      <div className="w-full max-w-2xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white">Registro</h1>
          <p className="mt-2 text-slate-600 dark:text-slate-400">Crea tu cuenta para empezar a usar TCalendar</p>
        </div>
