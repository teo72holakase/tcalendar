  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        {message && <div className="mb-4 rounded-3xl bg-emerald-100 p-4 text-sm text-emerald-800">{message}</div>}
        {error && <div className="mb-4 rounded-3xl bg-rose-100 p-4 text-sm text-rose-800">{error}</div>}
